...
/// Stores dictionaries in App Group container for sharing between LaVieKey and LaVieKeyIM
class VNDictionaryManager {
    ...
    private let appGroupIdentifier = "98NNYCQ84U.lavie.nguyen.inputmethod.LaVieKey"

    // Local storage path in App Group (shared between LaVieKey and LaVieKeyIM)
    private var dictionaryDirectory: URL {
        ...
        guard let containerURL = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: appGroupIdentifier) else {
            ...
            let dictDir = appSupport.appendingPathComponent("LaVieKey/Dictionaries")

# Input Method Kit (IMKit) Research for LaVieKey
...
│   ├── MacOS/
│   │   └── LaVieKeyIM          # Main executable
│   └── Resources/
│       └── LaVieKeyIM.tiff     # Icon
```
...
### 2. Coexistence với LaVieKey hiện tại
- Có thể chạy song song: LaVieKey (CGEvent) cho apps không hỗ trợ IMKit tốt
- LaVieKeyIM (IMKit) cho apps hỗ trợ tốt (terminals, IDEs)

### 3. Code sharing
- VNEngine có thể được share giữa LaVieKey và LaVieKeyIM
- Chỉ khác phần injection (CGEvent vs IMKit)

## Implementation Plan

### Phase 1: Prototype
1. Tạo LaVieKeyIM.app bundle riêng

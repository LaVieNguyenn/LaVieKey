...
//  LaVieKey
//
//  Shared settings between LaVieKey (menu bar) and LaVieKeyIM (Input Method)
//  Uses App Group for cross-app communication
//

import Foundation

/// App Group identifier for sharing data between LaVieKey and LaVieKeyIM
/// Note: macOS Sequoia+ requires TeamID prefix for native apps distributed outside App Store
let kLaVieKeyAppGroup = "98NNYCQ84U.lavie.nguyen.inputmethod.LaVieKey"

/// Keys for shared settings
enum SharedSettingsKey: String {
    // Hotkey settings
    case toggleHotkeyCode = "LaVieKey.toggleHotkeyCode"
    case toggleHotkeyModifiers = "LaVieKey.toggleHotkeyModifiers"
    case toggleHotkeyIsModifierOnly = "LaVieKey.toggleHotkeyIsModifierOnly"
    case undoTypingEnabled = "LaVieKey.undoTypingEnabled"
    case undoTypingHotkeyCode = "LaVieKey.undoTypingHotkeyCode"
    case undoTypingHotkeyModifiers = "LaVieKey.undoTypingHotkeyModifiers"
    case undoTypingHotkeyIsModifierOnly = "LaVieKey.undoTypingHotkeyIsModifierOnly"
    case beepOnToggle = "LaVieKey.beepOnToggle"

    // Input settings
    case inputMethod = "LaVieKey.inputMethod"
    case codeTable = "LaVieKey.codeTable"
    case modernStyle = "LaVieKey.modernStyle"
    case spellCheckEnabled = "LaVieKey.spellCheckEnabled"

    // Advanced settings
    case quickTelexEnabled = "LaVieKey.quickTelexEnabled"
    case quickStartConsonantEnabled = "LaVieKey.quickStartConsonantEnabled"
    case quickEndConsonantEnabled = "LaVieKey.quickEndConsonantEnabled"
    case upperCaseFirstChar = "LaVieKey.upperCaseFirstChar"
    case capitalizeOnlyAfterSpace = "LaVieKey.capitalizeOnlyAfterSpace"
    case restoreIfWrongSpelling = "LaVieKey.restoreIfWrongSpelling"
    case instantRestoreOnWrongSpelling = "LaVieKey.instantRestoreOnWrongSpelling"
    case skipRestoreForUppercaseVietnameseAbbreviations = "LaVieKey.skipRestoreForUppercaseVietnameseAbbreviations"
    ...
    case convertToolHotkeyCode = "LaVieKey.convertToolHotkeyCode"
    case convertToolHotkeyModifiers = "LaVieKey.convertToolHotkeyModifiers"

    // Macro settings
    case macroEnabled = "LaVieKey.macroEnabled"
    case macroInEnglishMode = "LaVieKey.macroInEnglishMode"
    case autoCapsMacro = "LaVieKey.autoCapsMacro"
    case addSpaceAfterMacro = "LaVieKey.addSpaceAfterMacro"
    case yieldMacroToSystemReplacement = "LaVieKey.yieldMacroToSystemReplacement"
    case macros = "LaVieKey.macros"

    // Smart switch settings
    case smartSwitchEnabled = "LaVieKey.smartSwitchEnabled"
    case smartSwitchData = "LaVieKey.smartSwitchData"          // JSON-encoded [String: Int] per-app language map

    // Debug settings
    case debugModeEnabled = "LaVieKey.debugModeEnabled"
    case debugHotkeyCode = "LaVieKey.debugHotkeyCode"
    case debugHotkeyModifiers = "LaVieKey.debugHotkeyModifiers"
    case openDebugOnLaunch = "LaVieKey.openDebugOnLaunch"

    // IMKit settings
    case imkitUseMarkedText = "LaVieKey.imkitUseMarkedText"
    case switchToLaVieKeyHotkeyCode = "LaVieKey.switchToLaVieKeyHotkeyCode"
    case switchToLaVieKeyHotkeyModifiers = "LaVieKey.switchToLaVieKeyHotkeyModifiers"
    case switchToLaVieKeyHotkeyIsModifierOnly = "LaVieKey.switchToLaVieKeyHotkeyIsModifierOnly"
    ...
    case kanjiConversionEnabled = "LaVieKey.kanjiConversionEnabled"
    ...
    // Excluded apps
    case excludedApps = "LaVieKey.excludedApps"
    case exclusionRulesEnabled = "LaVieKey.exclusionRulesEnabled"
    case toggleExclusionHotkeyCode = "LaVieKey.toggleExclusionHotkeyCode"
    case toggleExclusionHotkeyModifiers = "LaVieKey.toggleExclusionHotkeyModifiers"

    // Remote desktop injection mode
    case remoteDesktopInjectMode = "LaVieKey.remoteDesktopInjectMode"

    // Remote desktop target mode (this machine is being remoted into)
    case isRemoteDesktopTarget = "LaVieKey.isRemoteDesktopTarget"
    
    // Window Title Rules toggle
    case windowTitleRulesEnabled = "LaVieKey.windowTitleRulesEnabled"
    case toggleWindowRulesHotkeyCode = "LaVieKey.toggleWindowRulesHotkeyCode"
    case toggleWindowRulesHotkeyModifiers = "LaVieKey.toggleWindowRulesHotkeyModifiers"

    // Input Source Management
    case inputSourceConfig = "LaVieKey.inputSourceConfig"
    
    // Local data (macros, window title rules)
    case macrosData = "LaVieKey.macrosData"
    case windowTitleRules = "LaVieKey.windowTitleRules"
    case disabledBuiltInRules = "LaVieKey.disabledBuiltInRules"        // Rules enabled by default, now disabled by user
    case enabledBuiltInRules = "LaVieKey.enabledBuiltInRules"          // Rules disabled by default, now enabled by user
    
    // User dictionary (custom words to skip spell check)
    case userDictionaryWords = "LaVieKey.userDictionaryWords"
    
    // Translation settings
    case translationEnabled = "LaVieKey.translationEnabled"
    case translationHotkeyCode = "LaVieKey.translationHotkeyCode"
    case translationHotkeyModifiers = "LaVieKey.translationHotkeyModifiers"
    case translationSourceLanguage = "LaVieKey.translationSourceLanguage"
    case translationTargetLanguage = "LaVieKey.translationTargetLanguage"
    case translationReplaceOriginal = "LaVieKey.translationReplaceOriginal"
    case translationCopyToClipboard = "LaVieKey.translationCopyToClipboard"
    case translationShowPopup = "LaVieKey.translationShowPopup"                            // Show popup for target direction
    case translationToolbarEnabled = "LaVieKey.translationToolbarEnabled"
    case translateToSourceHotkeyCode = "LaVieKey.translateToSourceHotkeyCode"
    case translateToSourceHotkeyModifiers = "LaVieKey.translateToSourceHotkeyModifiers"
    case translateToSourceReplaceOriginal = "LaVieKey.translateToSourceReplaceOriginal"    // Replace text for source direction
    case translateToSourceCopyToClipboard = "LaVieKey.translateToSourceCopyToClipboard"    // Copy to clipboard for source direction
    case translateToSourceShowPopup = "LaVieKey.translateToSourceShowPopup"                // Show popup for source direction
    case translateToSourceAutoHideSeconds = "LaVieKey.translateToSourceAutoHideSeconds"    // Auto-hide seconds for source popup
    case translationResultAutoHideSeconds = "LaVieKey.translationResultAutoHideSeconds"
    
    // Translation provider configs
    case translationProviderConfigs = "LaVieKey.translationProviderConfigs"  // JSON-encoded [TranslationProviderConfig]
}

// Note: Logging functions (logError, logWarning, etc.) are provided by Shared/DebugLogger.swift

/// Manager for shared settings between LaVieKey and LaVieKeyIM
...
class SharedSettings {
    ...
    private lazy var plistURL: URL? = {
        guard let containerURL = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: kLaVieKeyAppGroup) else {
        ...
        return prefsDir.appendingPathComponent("\(kLaVieKeyAppGroup).plist")
    }()
    ...
    /// this cache directly. LaVieKeyIM only reads and refreshes via the distributed
    ...
    private static let processTag = "laviekey-\(ProcessInfo.processInfo.processIdentifier)"

    // MARK: - Initialization

    private init() {
        // One-time rebrand migration: settings written before the LaVieKey
        // rename live under "XKey."-prefixed keys in the same app-group plist.
        migrateLegacyXKeyKeys()

        // Refresh cache when settings change in another process
        // (LaVieKeyIM receives main-app writes; the main app receiving its own
        ...
        DistributedNotificationCenter.default().addObserver(
            forName: .lavieKeySettingsDidChange,
            object: nil,
            queue: nil
    ...
    /// Rename legacy "XKey."-prefixed keys to "LaVieKey." in the shared plist
    /// (and UserDefaults.standard). Runs in both the app and LaVieKeyIM; safe to
    /// repeat — it no-ops once no "XKey." keys remain. Existing "LaVieKey." keys
    /// are never overwritten, so post-rename settings always win.
    private func migrateLegacyXKeyKeys() {
        var dict = readPlistDict()
        let legacyKeys = dict.keys.filter { $0.hasPrefix("XKey.") }
        if !legacyKeys.isEmpty {
            for oldKey in legacyKeys {
                let newKey = "LaVieKey." + oldKey.dropFirst("XKey.".count)
                if dict[newKey] == nil {
            ...
            writePlistDict(dict)
            sharedLogInfo("Migrated \(legacyKeys.count) legacy XKey.* settings keys to LaVieKey.*")
        }

        let standard = UserDefaults.standard
        for (key, value) in standard.dictionaryRepresentation() where key.hasPrefix("XKey.") {
            let newKey = "LaVieKey." + key.dropFirst("XKey.".count)
    ...
    var switchToLaVieKeyHotkeyCode: UInt16 {
        get { UInt16(readInt(forKey: SharedSettingsKey.switchToLaVieKeyHotkeyCode.rawValue)) }
        set { writeInt(Int(newValue), forKey: SharedSettingsKey.switchToLaVieKeyHotkeyCode.rawValue) }
    }

    var switchToLaVieKeyHotkeyModifiers: UInt {
        get { UInt(readInt(forKey: SharedSettingsKey.switchToLaVieKeyHotkeyModifiers.rawValue)) }
        set { writeInt(Int(newValue), forKey: SharedSettingsKey.switchToLaVieKeyHotkeyModifiers.rawValue) }
    }

    var switchToLaVieKeyHotkeyIsModifierOnly: Bool {
        get { readBool(forKey: SharedSettingsKey.switchToLaVieKeyHotkeyIsModifierOnly.rawValue) }
        set { writeBool(newValue, forKey: SharedSettingsKey.switchToLaVieKeyHotkeyIsModifierOnly.rawValue) }
    }
    ...
    var kanjiConversionEnabled: Bool {
        get { readBool(forKey: SharedSettingsKey.kanjiConversionEnabled.rawValue) ?? false }
        set { writeBool(newValue, forKey: SharedSettingsKey.kanjiConversionEnabled.rawValue) }
    }
    ...
    func setMacrosData(_ data: Data) {
        ...
        // Editing the macro list must notify observers — writeData alone is silent.
        // During batch apply, isBatchUpdating suppresses this to avoid a notification echo.
        notifySettingsChanged()
    }
    ...
    func setWindowTitleRulesData(_ data: Data) {
        ...
        // Editing Window Title Rules must notify observers — writeData alone is silent.
        // During batch apply, isBatchUpdating suppresses this to avoid a notification echo.
        notifySettingsChanged()
    }
    ...
    private func notifySettingsChanged() {
        ...
        // the redundant cache invalidation (LaVieKeyIM observes with object: nil
        // and is unaffected by the object value).
        // deliverImmediately: LaVieKeyIM is a background IMK process — without it
        // the notification can be coalesced/held and its settings cache would
        // stay stale until the next delivery.
        DistributedNotificationCenter.default().postNotificationName(
            .lavieKeySettingsDidChange,
    ...
    func importSettings(from data: Data) -> Bool {
        do {
            ...
            // Notify observers
            notifySettingsChanged()
            // Post macros notification if available (LaVieKey only, not LaVieKeyIM)
            if let macrosNotification = Notification.Name(rawValue: "LaVieKey.macrosDidChange") as Notification.Name? {
    ...
    func getExportFileName() -> String {
        ...
        return "LaVieKey-Settings-\(dateString).plist"
    }
    ...
    func loadPreferences() -> Preferences {
        ...
        // Switch to LaVieKey hotkey (optional)
        let switchHotkeyCode = switchToLaVieKeyHotkeyCode
        let switchHotkeyModifiers = switchToLaVieKeyHotkeyModifiers
        if switchHotkeyCode != 0 || switchHotkeyModifiers != 0 {
            prefs.switchToLaVieKeyHotkey = Hotkey(
                keyCode: switchHotkeyCode,
                modifiers: ModifierFlags(rawValue: switchHotkeyModifiers),
                isModifierOnly: switchToLaVieKeyHotkeyIsModifierOnly
            )
        }
    ...
    func savePreferences(_ prefs: Preferences) {
        ...
        // Switch to LaVieKey hotkey (optional)
        if let switchHotkey = prefs.switchToLaVieKeyHotkey {
            switchToLaVieKeyHotkeyCode = switchHotkey.keyCode
            switchToLaVieKeyHotkeyModifiers = switchHotkey.modifiers.rawValue
            switchToLaVieKeyHotkeyIsModifierOnly = switchHotkey.isModifierOnly
        } else {
            // Clear the hotkey if nil
            switchToLaVieKeyHotkeyCode = 0
            switchToLaVieKeyHotkeyModifiers = 0
            switchToLaVieKeyHotkeyIsModifierOnly = false
        }
        ...
        // (LaVieKeyIM) never re-read the plist while these are still unwritten
        debugModeEnabled = prefs.debugModeEnabled
...
extension Notification.Name {
    ...
    static let sharedSettingsDidChange = Notification.Name("LaVieKey.sharedSettingsDidChange")
    
    /// Posted when settings change (distributed, cross-app)
    static let lavieKeySettingsDidChange = Notification.Name("LaVieKey.settingsDidChange")
    
    /// Posted when temp off toolbar settings change (enabled/disabled or hotkey)
    static let tempOffToolbarSettingsDidChange = Notification.Name("LaVieKey.tempOffToolbarSettingsDidChange")

    /// Posted after the Window Title Rules store is rewritten, so the typing engine
    /// (AppBehaviorDetector.customRules) and any open Settings tab reload instead of staying stale.
    static let windowTitleRulesDidChange = Notification.Name("LaVieKey.windowTitleRulesDidChange")

    /// Posted when convert tool hotkey changes
    static let convertToolHotkeyDidChange = Notification.Name("LaVieKey.convertToolHotkeyDidChange")

    /// Posted when translation settings change
    static let translationSettingsDidChange = Notification.Name("LaVieKey.translationSettingsDidChange")

    /// Posted when debug settings change
    static let debugSettingsDidChange = Notification.Name("LaVieKey.debugSettingsDidChange")
    
    /// Posted when translation toolbar settings change (enabled/disabled)
    static let translationToolbarSettingsDidChange = Notification.Name("LaVieKey.translationToolbarSettingsDidChange")
}

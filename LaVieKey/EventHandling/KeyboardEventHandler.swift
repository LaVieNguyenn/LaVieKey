...
class KeyboardEventHandler: EventTapManager.EventTapDelegate {
    ...
    func shouldProcessEvent(_ event: CGEvent, type: CGEventType) -> Bool {
        ...
        // Check if injection method is passthrough - bypass all LaVieKey processing.
    ...
    private func isWordBreakKey(_ character: Character) -> Bool {
        // Use centralized logic from VNEngine to ensure consistency with LaVieKeyIM
    ...
    /// so the remote machine handles Vietnamese input. When ON, LaVieKey injects

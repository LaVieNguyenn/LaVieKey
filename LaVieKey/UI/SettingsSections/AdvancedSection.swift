...
struct AdvancedSection: View {
            ...
            VStack(alignment: .leading, spacing: 20) {
                            ...
                            VStack(alignment: .leading, spacing: 10) {
                                ...
                                VStack(alignment: .leading, spacing: 4) {
                                    Text("Từ điển chứa các từ đơn tiếng Việt.")
                                        .font(.caption)
                                        .foregroundColor(.secondary)
                                    Text("LaVieKey sẽ ưu tiên từ điển để xác định chính tả Tiếng Việt và tự động hoàn tác nếu từ đang gõ không tồn tại trong từ điển này. Bạn cũng có thể thêm các \"Từ điển cá nhân\" để bỏ qua việc kiểm tra chính tả đối với các từ mà bạn coi là hợp lệ.")
                                        .font(.caption)
                                        .foregroundColor(.secondary)
                                }
                ...
                SettingsGroup(title: "Công cụ điều khiển") {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Toggle("Bật thanh công cụ điều khiển LaVieKey", isOn: $viewModel.preferences.tempOffToolbarEnabled)
                ...
                // Window Title Rules
                SettingsGroup(title: "Hiệu chỉnh LaVieKey Engine theo ứng dụng") {
                    VStack(alignment: .leading, spacing: 12) {
                ...
                SettingsGroup(title: "Remote Desktop") {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Text("BẬT khi máy này là máy đích (machine B) — máy đang bị remote control bởi Jump Desktop, AnyDesk, TeamViewer, RustDesk, v.v.\n\nKhi BẬT: LaVieKey luôn lắng nghe keyboard events từ remote desktop daemon (bypass HID tap). Cho phép gõ tiếng Việt bình thường trên máy B khi máy A disable LaVieKey.\n\nĐể TẮT khi máy A disable LaVieKey và bạn muốn gõ tiếng Việt trực tiếp trên máy B.")
                            .font(.caption)
                            .foregroundColor(.secondary)
                ...
                SettingsGroup(title: "Debug") {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Text("Khi bật, cửa sổ Debug sẽ tự động hiển thị mỗi khi khởi động LaVieKey")
                            .font(.caption)
                            .foregroundColor(.secondary)
                    }
                }
    ...
    private var userDictionarySection: some View {
        ...
        .fileExporter(
            ...
            defaultFilename: "laviekey_user_dictionary.txt"
        ) { result in

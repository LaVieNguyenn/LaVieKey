...
struct BackupRestoreSection: View {
    ...
    var body: some View {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        HStack(spacing: 6) {
                            Image(systemName: "exclamationmark.triangle.fill")
                                ...
                                .font(.caption)
                            Text("Import sẽ ghi đè toàn bộ thiết lập hiện tại và tự động khởi động lại LaVieKey.")
                                .font(.caption)
                                .foregroundColor(.secondary)
                        }
                    }
        ...
        .alert("Khôi phục mặc định?", isPresented: $showResetConfirmation) {
            ...
            Text("Toàn bộ cài đặt, macro, từ điển tuỳ chỉnh, quy tắc và cấu hình dịch thuật sẽ bị xoá. LaVieKey sẽ trở về trạng thái như mới cài đặt.\n\nHãy export backup trước nếu bạn muốn giữ lại thiết lập hiện tại.")
        }
    ...
    private func exportSettings() {
        ...
        panel.message = String(localized: "Lưu file thiết lập LaVieKey")
    ...
    private func importSettings() {
        ...
        panel.message = String(localized: "Chọn file thiết lập LaVieKey để import")
        panel.allowedContentTypes = [.propertyList]
...
struct RestartCountdownView: View {
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("LaVieKey sẽ tự động khởi động lại sau")
                .font(.subheadline)
                .foregroundColor(.secondary)
